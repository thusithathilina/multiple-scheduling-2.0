...
def view_results(date_folder, time_folder):
    ...
    # source = ColumnDataSource(demands_prices_fw_dict[k0_prices][k1_optimal_fw])
    # display_keys = demands_prices_fw_dict[k0_prices][k1_optimal_fw].keys()
    ...
    def update_data_table_content(attr, old, new):
        ...
        if new == 0:  # demand
            source.data = demands_prices_fw_dict[k0_profile][select_algorithm.value]
        elif new == 1:  # prices

...
def pricing_step_size(price_levels, demand_table, demand_profile_pre, demand_profile_new, cost_type):
    best_step_size = 1
...
def pricing_master_problem(iteration, price_levels, demand_table, area, cost_type):
    ...
    heuristic_demand_profile_updated, heuristic_best_step_size, heuristic_price_day, heuristic_cost \
        = pricing_step_size(price_levels, demand_table,
                            heuristic_demand_profile_pre, heuristic_demand_profile_new, cost_type)

    optimal_demand_profile_updated, optimal_best_step_size, optimal_price_day, optimal_cost \
        = pricing_step_size(price_levels, demand_table,
                            optimal_demand_profile_pre, optimal_demand_profile_new, cost_type)
